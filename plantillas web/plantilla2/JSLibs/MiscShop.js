...
function elegirlenguaje() {
  if (top.centralflags.charAt(0)=="1") { 
    cerrarventanas();
    top.handleventana=window.open(ajustarurlpagina(false) + "chooselanguage.htm","VENTALENGUAJE","height=50,width=400,resizable=no");
  }
}
...
function iniciarbusqueda() {
  ...
  urlpagina=ajustarurlpagina(false);
  ...
  if (modelopagina==0) {
    location.href=urlpagina + "search.htm?b=" + escape(arpartesbusqueda.join("|")) + "&p=1";
  }
  else {
    location.href=urlpagina + "search.htm?inframe=1&b=" + escape(arpartesbusqueda.join("|")) + "&p=1";
  }
}
...
function iradisclaimer() {
  ...
  if (top.centralflags.charAt(0)=="1") { 
    if (ponerdisclaimerenunacapa==true) {
      ...
      cerrarventanas();
      top.handleventana=window.open(ajustarurlpagina(false)+"disclaimer.htm","VENTALENGUAJE","height=500,width=500,resizable=no,scrollbars=yes");
...
function iracategorias() {
  ...
  if (modelopagina==0) {
    location.href=urlpagina+"categories.htm?p=1";

  }
  else {
    location.href=urlpagina + "categories.htm?inframe=1&p=1";
  }
}
...
function iraproductos() {
  ...
  if (modelopagina==0) {
    location.href=urlpagina + "products.htm?c=0&s=0&p=1";

  }
  else {
    location.href=urlpagina +  "products.htm?c=0&s=0&p=1&inframe=1";
  }
...
function iravercambiarproductos() {
  ...
  urlpagina=ajustarurlpagina(false)
  if (modelopagina==0) {
    location.href=urlpagina + "viewchangeorder.htm";

  }
  else {
    location.href=urlpagina + "viewchangeorder.htm?inframe=1";
  }
}
...
function irapaginacategorias(npagina) {
  ...
  if (modelopagina==0) {
    location.href=urlpagina + "categories.htm?p=" + escape(npagina);

  }
  else {
    location.href=urlpagina + "categories.htm?inframe=1&p=" + escape(npagina);
  }
...
function iraprincipal() {
  ...
  if (modelopagina==0) {
    location.href=urlpagina + "index.htm";

  }
  else {
    location.href=urlpagina + "index.htm?inframe=1";
  }
...
function irapaginabusquedas(npagina) {
  ...
  location.href=urlpagina + "search.htm" + qshurlpagina.toString();
...
function iranumeropaginasproductos(npagina) {
  ...
  urlpagina=ajustarurlpagina(false);
  qshurlpagina.add("p",npagina);
  location.href=urlpagina + "products.htm" + qshurlpagina.toString();
...
function irafichagrande(nproducto,nmodelo) {
  ...
  if (modelopagina==0) {
    location.href=urlpagina + "addtocart.htm?p=" + escape(nproducto) + "&m="+escape(nmodelo) + "&u=1";

  }
  else {
    location.href=urlpagina + "addtocart.htm?inframe=1&p=" + escape(nproducto) + "&m="+escape(nmodelo) + "&u=1";
...
function elegirmodelo() {
  ...
  location.href=urlpagina + "addtocart.htm" + qshurlpagina.toString(); 
...
function iracomprarpedido() {
  var urlpagina="";
  urlpagina=ajustarurlpagina(enviarpedidoviahttps);
  top.hayqueactualizar=true;
  if (modelopagina==0) {
    location.href=urlpagina + "buycart.htm";

  }
  else {
    location.href=urlpagina + "buycart.htm?inframe=1";
  }
...
function mostrarlicencia() {
  ...
  if (top.centralflags.charAt(0)=="1") { 
    if (ponerlicenciaenunacapa==true) {
      ...
      cerrarventanas();
      top.handleventana=window.open(ajustarurlpagina(false)+"license.htm","VENTALENGUAJE","height=500,width=500,resizable=no,scrollbars=yes");
...
function ajustarurlpagina(usarservidorseguro) {

  var cadenaurl;


  if (usarservidorseguro==true) {
    cadenaurl="https://";
    cadenaurl=cadenaurl + location.host;
    cadenaurl=cadenaurl + ":" +puertohttps;

  }
  else {
    cadenaurl="http://";
    cadenaurl=cadenaurl + location.host;
    cadenaurl=cadenaurl + ":" +puertohttp;

  }
  cadenaurl=cadenaurl+location.pathname;

  if (cadenaurl.substring(cadenaurl.length-16)=="cgi-bin/final.pl") {
    cadenaurl=cadenaurl.substring(0,cadenaurl.length-16);
  } 

  else if (cadenaurl.charAt(cadenaurl.length-1)!="/") {
     cadenaurl=cadenaurl.substring(0,cadenaurl.lastIndexOf("/")+1);
  }
  return cadenaurl;
